#############################################################################
# Makefile for building: MVR-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: ?? ??? 20 15:51:00 2017
# Project:  coin-qt.pro
# Template: app
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lminiupnpc /tmp/mv/src/leveldb/libleveldb.a /tmp/mv/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lpthread -lQtGui -lQtCore 
AR            = ar cqs
RANLIB        = 
...
/tmp/mv/src/leveldb/libleveldb.a: FORCE
	cd /tmp/mv/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-fpermissive -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/tmp/mv/build/build.h: FORCE
	cd /tmp/mv; /bin/sh share/genbuild.sh /tmp/mv/build/build.h
...
install_target: first FORCE
	@$(CHK_DIR_EXISTS) $(INSTALL_ROOT)/usr/lib/MVR/ || $(MKDIR) $(INSTALL_ROOT)/usr/lib/MVR/ 
	-$(INSTALL_PROGRAM) "$(QMAKE_TARGET)" "$(INSTALL_ROOT)/usr/lib/MVR/$(QMAKE_TARGET)"
	-$(STRIP) "$(INSTALL_ROOT)/usr/lib/MVR/$(QMAKE_TARGET)"

uninstall_target:  FORCE
	-$(DEL_FILE) "$(INSTALL_ROOT)/usr/lib/MVR/$(QMAKE_TARGET)"
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/lib/MVR/ 
